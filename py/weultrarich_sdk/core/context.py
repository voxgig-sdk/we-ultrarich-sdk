...
from weultrarich_sdk.core.helpers import get_ctx_prop, to_map
...
class WeUltrarichContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(sp, WeUltrarichSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, WeUltrarichResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, WeUltrarichResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return WeUltrarichError(code, msg, self)
