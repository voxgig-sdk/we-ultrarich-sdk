...
from weultrarich_sdk.weultrarich_types import (
    WealthExpression,
...
class WealthExpressionEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return WealthExpressionEntity(self._client, opts)
    ...
    def data_get(self) -> WealthExpression:
    ...
    def match_get(self) -> WealthExpression:
    ...
    def load(self, reqmatch=None, ctrl=None) -> WealthExpression:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.WealthExpression().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
