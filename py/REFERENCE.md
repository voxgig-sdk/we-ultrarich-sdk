# WeUltrarich Python SDK Reference

Complete API reference for the WeUltrarich Python SDK.
...
#### `WeUltrarichSDK.test(testopts=None, sdkopts=None)`
...
Create a new `ComparisonEntity` instance. Pass `None` for no initial data.

#### `Discovery(data=None)`

Create a new `DiscoveryEntity` instance. Pass `None` for no initial data.

#### `WealthExpression(data=None)`

Create a new `WealthExpressionEntity` instance. Pass `None` for no initial data.
...
```python
result = client.Comparison().load({"expression": "expression", "wealth_their": "wealth_their", "wealth_your": "wealth_your"})
```
...
Create a new `ComparisonEntity` instance with the same options.
...
Create a new `DiscoveryEntity` instance with the same options.
...
```python
result = client.WealthExpression().load({"wealth": "wealth"})
```
...
Create a new `WealthExpressionEntity` instance with the same options.
