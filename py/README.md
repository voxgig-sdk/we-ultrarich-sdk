# WeUltrarich Python SDK



The Python SDK for the WeUltrarich API — an entity-oriented client following Pythonic conventions.

The SDK exposes the API as capitalised, semantic **Entities** — for example `client.Comparison()` — each
...
release tag (`py/vX.Y.Z`, see [Releases](https://github.com/voxgig-sdk/we-ultrarich-sdk/releases)) or
...
```
py/
├── weultrarich_sdk.py         -- Main SDK module
