...
from weultrarich_sdk.core.result import WeUltrarichResult
from weultrarich_sdk.core.response import WeUltrarichResponse
from weultrarich_sdk.core.operation import WeUltrarichOperation
...
def _err_from_map(m):
    ...
    if msg == "":
        return None
    code = m.get("code", "")
    return WeUltrarichError(code, msg)
...
class TestPrimaryUtility:
    ...
    def test_exists(self):
        client = WeUltrarichSDK.test(None, None)
    ...
    def test_feature_init_basic(self):
        init_client = WeUltrarichSDK.test(None, None)
        ...
        class TestInitFeature(WeUltrarichBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "initfeat"
                self.active = True
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(WeUltrarichBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_make_result_no_result(self):
        ...
        utility = client._utility
        ctx = _make_test_full_ctx(client, utility)
        ctx.spec = WeUltrarichSpec({"step": "start"})
        ctx.result = None
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = WeUltrarichSDK.test(None, setup_opts)
    ...
    def test_operator_basic(self):
        ...
        def subject(entry):
            ...
            if not isinstance(in_val, dict):
                in_val = {}
            op = WeUltrarichOperation(in_val)
            return {
                "entity": op.entity,
                "name": op.name,
                "input": op.input,
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = WeUltrarichSDK.test(None, setup_opts)
