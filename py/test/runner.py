...
class WeUltrarichTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = WeUltrarichTestRunner.getenv("WEULTRARICH_TEST_LIVE")
        override = WeUltrarichTestRunner.getenv("WEULTRARICH_TEST_OVERRIDE")
        ...
        explain = WeUltrarichTestRunner.getenv("WEULTRARICH_TEST_EXPLAIN")
