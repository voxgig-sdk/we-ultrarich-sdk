# WeUltrarich SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions WeUltrarichSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both WeUltrarichSDK(...) and WeUltrarichSDK.test(...) become
#      WeUltrarichSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "weultrarich_sdk"
_SDK_CLASS = "WeUltrarichSDK"
...
_ENTITIES = {
    ...
    "Discovery": "discovery",
    "WealthExpression": "wealth_expression",
}
