...
func registerSDKWords(r *eng.Registry, client *sdk.WeUltrarichSDK) {
...
func runOp(client *sdk.WeUltrarichSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
