...
function envOverride(m) {
    if ('TRUE' === process.env.WE_ULTRARICH_TEST_LIVE ||
        'TRUE' === process.env.WE_ULTRARICH_TEST_OVERRIDE) {
    ...
    m.WE_ULTRARICH_TEST_EXPLAIN = process.env.WE_ULTRARICH_TEST_EXPLAIN || m.WE_ULTRARICH_TEST_EXPLAIN;
    return m;
}
