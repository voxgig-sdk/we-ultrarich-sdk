...
(0, node_test_1.describe)('WealthExpressionDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.WeUltrarichSDK({
    ...
    (0, node_test_1.test)('direct-load-wealth_expression', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-wealth_expression', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.WeUltrarichSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['WE_ULTRARICH_TEST_WEALTH_EXPRESSION_ENTID'];
    ...
    const client = new __1.WeUltrarichSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=WealthExpressionDirect.test.js.map