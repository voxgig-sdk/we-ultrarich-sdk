...
(0, node_test_1.describe)('WealthExpressionEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['load']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'wealth_expression.' + op, live))
                return;
        }
        ...
        if (setup.syntheticOnly) {
            t.skip('live entity test uses synthetic IDs from fixture — set WE_ULTRARICH_TEST_WEALTH_EXPRESSION_ENTID JSON to run live');
            return;
        }
        ...
        let wealth_expression_ref01_data = Object.values(setup.data.existing.wealth_expression)[0];
        // LOAD
        const wealth_expression_ref01_ent = client.WealthExpression();
        const wealth_expression_ref01_match_dt0 = {};
        const wealth_expression_ref01_data_dt0 = (await wealth_expression_ref01_ent.load(wealth_expression_ref01_match_dt0)).data();
        (0, node_assert_1.default)(null != wealth_expression_ref01_data_dt0);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/wealth_expression/WealthExpressionTestData.json');
    ...
    let idmap = transform(['wealth_expression01', 'wealth_expression02', 'wealth_expression03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    const idmapEnvVal = process.env['WE_ULTRARICH_TEST_WEALTH_EXPRESSION_ENTID'];
...
//# sourceMappingURL=WealthExpressionEntity.test.js.map