...
(0, node_test_1.describe)('DiscoveryEntity', async () => {
...
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/discovery/DiscoveryTestData.json');
    ...
    let idmap = transform(['discovery01', 'discovery02', 'discovery03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=DiscoveryEntity.test.js.map