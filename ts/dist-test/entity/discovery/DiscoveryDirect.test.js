...
(0, node_test_1.describe)('DiscoveryDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-discovery', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-discovery', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['WE_ULTRARICH_TEST_DISCOVERY_ENTID'];
...
//# sourceMappingURL=DiscoveryDirect.test.js.map