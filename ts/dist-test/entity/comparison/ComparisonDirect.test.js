...
(0, node_test_1.describe)('ComparisonDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-comparison', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-comparison', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['WE_ULTRARICH_TEST_COMPARISON_ENTID'];
...
//# sourceMappingURL=ComparisonDirect.test.js.map