...
The PHP SDK for the WeUltrarich API — an entity-oriented client using PHP conventions.
...
```php
<?php
require_once 'weultrarich_sdk.php';
...
```php
// list() returns an array of Discovery records (throws on error).
...
```
php/
├── weultrarich_sdk.php          -- Main SDK class
...
The main class (`weultrarich_sdk.php`) exports the SDK class
