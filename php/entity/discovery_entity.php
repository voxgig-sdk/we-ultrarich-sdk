...
// WeUltrarich SDK Discovery entity
...
class DiscoveryEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new DiscoveryEntity($this->_client, $opts);
    }

    /**
     * @param Discovery|array $args Discovery data (assoc-array) to store.
     */
    ...
    /**
     * @return Discovery|array The current Discovery data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Discovery fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Discovery fields).
     */
    ...
    /**
     * List Discovery items matching the given filter.
     *
     * @param DiscoveryListMatch|array|null $reqmatch Match filter (any subset
     *   of Discovery fields) as an assoc-array; DiscoveryListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Discovery[]|array A list of Discovery items as assoc-arrays at
     *   the SDK boundary; throws WeUltrarichError on failure (item-5 convention).
     */
