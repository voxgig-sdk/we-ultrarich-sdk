...
// WeUltrarich SDK Comparison entity
...
class ComparisonEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new ComparisonEntity($this->_client, $opts);
    }

    /**
     * @param Comparison|array $args Comparison data (assoc-array) to store.
     */
    ...
    /**
     * @return Comparison|array The current Comparison data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Comparison fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Comparison fields).
     */
     ...
     *
     * @param ComparisonLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed ComparisonLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Comparison|array The loaded Comparison as an assoc-array at the
