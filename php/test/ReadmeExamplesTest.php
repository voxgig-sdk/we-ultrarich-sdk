...
// WeUltrarich SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (WeUltrarichSDK::test)
...
{
    private const SDK_CLASS = 'WeUltrarichSDK';
    ...
    private const SDK_BASE = 'weultrarich_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../weultrarich_sdk.php';
