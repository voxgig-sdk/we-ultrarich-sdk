...
// WeUltrarich SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = WeUltrarichOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(WeUltrarichOmni::structfix($now, Struct::undef()))
                        !== json_encode(WeUltrarichOmni::structfix($val, Struct::undef()))) {
