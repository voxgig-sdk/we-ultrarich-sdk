...
class ComparisonEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set WE_ULTRARICH_TEST_COMPARISON_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function comparison_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("WE_ULTRARICH_TEST_COMPARISON_ENTID");
