...
// WeUltrarich SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class WeUltrarichMakeRequest
{
    public static function call(WeUltrarichContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new WeUltrarichResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new WeUltrarichResponse($fetched);
        } else {
