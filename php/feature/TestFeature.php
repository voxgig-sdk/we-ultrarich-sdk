...
// WeUltrarich SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class WeUltrarichTestFeature extends WeUltrarichBaseFeature
{
    ...
    public function init(WeUltrarichContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (WeUltrarichContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
            ...
            if ($op->name === 'load') {
                ...
                $id = WeUltrarichParam::call($fctx, 'id');
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (WeUltrarichContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(WeUltrarichContext $ctx, $op, $args): array
    {
