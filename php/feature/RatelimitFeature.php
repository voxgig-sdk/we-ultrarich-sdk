...
// WeUltrarich SDK ratelimit feature
...
class WeUltrarichRatelimitFeature extends WeUltrarichBaseFeature
{
    ...
    private function _acquire(WeUltrarichContext $ctx): void
    {
    ...
    private function _track(WeUltrarichContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
