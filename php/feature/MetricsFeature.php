...
// WeUltrarich SDK metrics feature
...
class WeUltrarichMetricsFeature extends WeUltrarichBaseFeature
{
    ...
    private function _record(WeUltrarichContext $ctx, bool $ok): void
    {
