...
// WeUltrarich SDK timeout feature
...
class WeUltrarichTimeoutFeature extends WeUltrarichBaseFeature
{
    ...
    private function _with_timeout(WeUltrarichContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(WeUltrarichContext $_ctx, float $ms): void
    {
        $client = $this->client;
