...
// WeUltrarich SDK netsim feature
...
class WeUltrarichNetsimFeature extends WeUltrarichBaseFeature
{
    ...
    private function _simulate(WeUltrarichContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(WeUltrarichContext $ctx, array $applied): void
    {
        $client = $this->client;
