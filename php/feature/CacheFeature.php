...
class WeUltrarichCacheFeature extends WeUltrarichBaseFeature
{
    ...
    private function _through(WeUltrarichContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
