...
func NewDiscoveryEntity(client *core.WeUltrarichSDK, entopts map[string]any) *DiscoveryEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *DiscoveryEntity) GetName() string { return e.name }
...
func (e *DiscoveryEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *DiscoveryEntity) Deleted() bool {
	return e.deleted
}


func (e *DiscoveryEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewDiscoveryEntity(e.client, opts)
}

func (e *DiscoveryEntity) Data(args ...any) any {
...
func (e *DiscoveryEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Discovery; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *DiscoveryEntity) DataTyped(data ...Discovery) Discovery {
	if len(data) > 0 {
		return typedFrom[Discovery](e.Data(asMap(data[0])))
	}
	return typedFrom[Discovery](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Discovery (all fields
// optional at the wire level).
func (e *DiscoveryEntity) MatchTyped(match ...Discovery) Discovery {
	if len(match) > 0 {
		return typedFrom[Discovery](e.Match(asMap(match[0])))
	}
	return typedFrom[Discovery](e.Match())
}
...
func (e *DiscoveryEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *DiscoveryEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *DiscoveryEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// DiscoveryListMatch and returns []Discovery. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *DiscoveryEntity) ListTyped(reqmatch DiscoveryListMatch, ctrl map[string]any) ([]Discovery, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Discovery](res), nil
}



func (e *DiscoveryEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *DiscoveryEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *DiscoveryEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *DiscoveryEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
