...
func NewComparisonEntity(client *core.WeUltrarichSDK, entopts map[string]any) *ComparisonEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *ComparisonEntity) GetName() string { return e.name }
...
func (e *ComparisonEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *ComparisonEntity) Deleted() bool {
	return e.deleted
}


func (e *ComparisonEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewComparisonEntity(e.client, opts)
}

func (e *ComparisonEntity) Data(args ...any) any {
...
func (e *ComparisonEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Comparison; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *ComparisonEntity) DataTyped(data ...Comparison) Comparison {
	if len(data) > 0 {
		return typedFrom[Comparison](e.Data(asMap(data[0])))
	}
	return typedFrom[Comparison](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Comparison (all fields
// optional at the wire level).
func (e *ComparisonEntity) MatchTyped(match ...Comparison) Comparison {
	if len(match) > 0 {
		return typedFrom[Comparison](e.Match(asMap(match[0])))
	}
	return typedFrom[Comparison](e.Match())
}
...
func (e *ComparisonEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *ComparisonEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// ComparisonLoadMatch and returns an Comparison. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *ComparisonEntity) LoadTyped(reqmatch ComparisonLoadMatch, ctrl map[string]any) (Comparison, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Comparison{}, err
	}
	return typedFrom[Comparison](res), nil
}



func (e *ComparisonEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *ComparisonEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *ComparisonEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *ComparisonEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *ComparisonEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
