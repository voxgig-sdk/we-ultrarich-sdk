...
type WealthExpressionEntity struct {
	name    string
	client  *core.WeUltrarichSDK
...
func NewWealthExpressionEntity(client *core.WeUltrarichSDK, entopts map[string]any) *WealthExpressionEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *WealthExpressionEntity) GetName() string { return e.name }
...
func (e *WealthExpressionEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *WealthExpressionEntity) Deleted() bool {
	return e.deleted
}


func (e *WealthExpressionEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewWealthExpressionEntity(e.client, opts)
}

func (e *WealthExpressionEntity) Data(args ...any) any {
...
func (e *WealthExpressionEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an WealthExpression; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *WealthExpressionEntity) DataTyped(data ...WealthExpression) WealthExpression {
	if len(data) > 0 {
		return typedFrom[WealthExpression](e.Data(asMap(data[0])))
	}
	return typedFrom[WealthExpression](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through WealthExpression (all fields
// optional at the wire level).
func (e *WealthExpressionEntity) MatchTyped(match ...WealthExpression) WealthExpression {
	if len(match) > 0 {
		return typedFrom[WealthExpression](e.Match(asMap(match[0])))
	}
	return typedFrom[WealthExpression](e.Match())
}
...
func (e *WealthExpressionEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *WealthExpressionEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// WealthExpressionLoadMatch and returns an WealthExpression. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *WealthExpressionEntity) LoadTyped(reqmatch WealthExpressionLoadMatch, ctrl map[string]any) (WealthExpression, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return WealthExpression{}, err
	}
	return typedFrom[WealthExpression](res), nil
}



func (e *WealthExpressionEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *WealthExpressionEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *WealthExpressionEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *WealthExpressionEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *WealthExpressionEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
