...
const testSeed = `map[string]any{"entity": map[string]any{"comparison": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "discovery": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "wealth_expression": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
