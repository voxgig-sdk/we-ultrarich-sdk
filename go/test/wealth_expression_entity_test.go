...
func TestWealthExpressionEntity(t *testing.T) {
	...
	t.Run("basic", func(t *testing.T) {
		...
		wealthExpressionRef01DataRaw := vs.Items(core.ToMapAny(vs.GetPath(setup.data, "existing.wealth_expression")))
...
func wealth_expressionBasicSetup(extra map[string]any) *entityTestSetup {
	...
	entidEnvRaw := os.Getenv("WE_ULTRARICH_TEST_WEALTH_EXPRESSION_ENTID")
	...
	idmapResolved := core.ToMapAny(env["WE_ULTRARICH_TEST_WEALTH_EXPRESSION_ENTID"])
