...
// WeUltrarich SDK utility: graphql
//
...
class WeUltrarichGraphql
{
    ...
    // equivalent.
    public static function body(WeUltrarichContext $ctx): mixed
    {
    ...
    public static function errors(WeUltrarichContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
