...
// WeUltrarich SDK utility: fetcher

class WeUltrarichFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; WeUltrarichSDK/1.0)';
    ...
    public static function call(WeUltrarichContext $ctx, string $fullurl, array $fetchdef): array
    {
