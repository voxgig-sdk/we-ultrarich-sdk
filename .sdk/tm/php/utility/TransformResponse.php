...
// WeUltrarich SDK utility: transform_response

require_once __DIR__ . '/../core/Helpers.php';

class WeUltrarichTransformResponse
{
    public static function call(WeUltrarichContext $ctx): mixed
    {
        ...
        $transform = WeUltrarichHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return null;
        }
