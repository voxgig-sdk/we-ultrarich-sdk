...
{
    private static function utility(): WeUltrarichUtility
    {
        return new WeUltrarichUtility();
    }
    ...
    private static function ctx(array $over = []): WeUltrarichContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new WeUltrarichContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new WeUltrarichOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof WeUltrarichError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new WeUltrarichOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = WeUltrarichMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new WeUltrarichOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = WeUltrarichMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new WeUltrarichOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = WeUltrarichMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new WeUltrarichSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = WeUltrarichMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new WeUltrarichResponse([]),
            'result' => new WeUltrarichResult([]),
        ]);
        [, $err] = WeUltrarichMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new WeUltrarichSpec([]),
            'response' => null,
            'result' => new WeUltrarichResult([]),
        ]);
        [, $err] = WeUltrarichMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new WeUltrarichSpec(['step' => 's']),
            'response' => new WeUltrarichResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new WeUltrarichResult([]),
        ]);
        [, $err] = WeUltrarichMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new WeUltrarichSpec(['step' => 's']),
            'response' => new WeUltrarichResponse(self::resp(200, ['v' => 1])),
            'result' => new WeUltrarichResult([]),
        ]);
        [, $err] = WeUltrarichMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new WeUltrarichSpec(['step' => 's']),
            'response' => new WeUltrarichResponse(self::resp(200, ['v' => 2])),
            'result' => new WeUltrarichResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        WeUltrarichMakeResponse::call($ctx);
    ...
    {
        $preset = new WeUltrarichResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new WeUltrarichSpec([]),
            'response' => new WeUltrarichResponse([]),
            'result' => new WeUltrarichResult([]),
        ...
        [$got, $err] = WeUltrarichMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new WeUltrarichResult([])]);
        [, $err] = WeUltrarichMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new WeUltrarichSpec([]), 'result' => null]);
        [, $err] = WeUltrarichMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new WeUltrarichSpec(['step' => 's']),
            'result' => new WeUltrarichResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new WeUltrarichOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = WeUltrarichMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new WeUltrarichSpec(['step' => 's']),
            'result' => new WeUltrarichResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new WeUltrarichOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = WeUltrarichMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new WeUltrarichResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new WeUltrarichSpec([]),
            'result' => new WeUltrarichResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = WeUltrarichMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = WeUltrarichMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new WeUltrarichError('boom', 'boom');
        $utility->fetcher = function (WeUltrarichContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new WeUltrarichSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = WeUltrarichMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (WeUltrarichContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = WeUltrarichMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(WeUltrarichResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        WeUltrarichMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (WeUltrarichContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new WeUltrarichSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = WeUltrarichMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new WeUltrarichResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new WeUltrarichSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = WeUltrarichMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = WeUltrarichMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = WeUltrarichMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new WeUltrarichResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, WeUltrarichDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new WeUltrarichResult(['ok' => false])]);
        $this->expectException(WeUltrarichError::class);
        WeUltrarichDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new WeUltrarichResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', WeUltrarichMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        WeUltrarichMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new WeUltrarichBaseFeature();
        $b = new WeUltrarichBaseFeature();
        WeUltrarichFeatureAdd::call($ctx, $a);
        WeUltrarichFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): WeUltrarichBaseFeature
    {
        $f = new WeUltrarichBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        WeUltrarichFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): WeUltrarichContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new WeUltrarichSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = WeUltrarichPrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_a_raw_apikey_goes_in_as_is(): void
    {
        ...
        WeUltrarichPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new WeUltrarichResponse(['headers' => null]),
            'result' => new WeUltrarichResult([]),
        ]);
        WeUltrarichResultHeaders::call($ctx);
    ...
    public function test_result_body_skips_parsing_when_the_body_is_absent(): void
    {
        ...
        WeUltrarichResultBody::call($ctx);
