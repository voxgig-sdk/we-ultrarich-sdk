...
class WeUltrarichProxyFeature extends WeUltrarichBaseFeature
{
    ...
    public function init(WeUltrarichContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (WeUltrarichContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
