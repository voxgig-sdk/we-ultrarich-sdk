...
class WeUltrarichRbacFeature extends WeUltrarichBaseFeature
{
    ...
    private function _required(WeUltrarichContext $ctx): ?string
    {
    ...
    private function _reject(WeUltrarichContext $ctx, string $required): void
    {
    ...
    private function _track(WeUltrarichContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
