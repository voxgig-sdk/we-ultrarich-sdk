...
// WeUltrarich SDK clienttrack feature
...
class WeUltrarichClienttrackFeature extends WeUltrarichBaseFeature
{
    ...
    public function PostConstruct(WeUltrarichContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'WeUltrarich-SDK';
