...
// WeUltrarich SDK streaming feature
...
class WeUltrarichStreamingFeature extends WeUltrarichBaseFeature
{
    ...
    private function _iterate(WeUltrarichResult $result): \Generator
    {
    ...
    private function _streamable(WeUltrarichContext $ctx): bool
    {
