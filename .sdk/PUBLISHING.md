...
|---|---|---|
| `ts/` | @voxgig-sdk/we-ultrarich-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/we-ultrarich-sdk \
      --repository voxgig-sdk/we-ultrarich-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/we-ultrarich-sdk` shows it, and
`npm trust revoke @voxgig-sdk/we-ultrarich-sdk --id=<id>` removes it.
