...
describe("WealthExpressionDirect", function()
  it("should direct-load-wealth_expression", function()
    local setup = wealth_expression_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-wealth_expression", setup.live and "live" or "unit")
