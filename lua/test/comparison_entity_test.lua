...
describe("ComparisonEntity", function()
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set WE_ULTRARICH_TEST_COMPARISON_ENTID JSON to run live")
      return
    end
...
function comparison_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("WE_ULTRARICH_TEST_COMPARISON_ENTID")
