...
describe("ComparisonDirect", function()
  it("should direct-load-comparison", function()
    local setup = comparison_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-comparison", setup.live and "live" or "unit")
