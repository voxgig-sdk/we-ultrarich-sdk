...
describe("DiscoveryDirect", function()
  it("should direct-list-discovery", function()
    local setup = discovery_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-discovery", setup.live and "live" or "unit")
