...
describe("WealthExpressionEntity", function()
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set WEULTRARICH_TEST_WEALTH_EXPRESSION_ENTID JSON to run live")
      return
    end
...
function wealth_expression_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("WEULTRARICH_TEST_WEALTH_EXPRESSION_ENTID")
