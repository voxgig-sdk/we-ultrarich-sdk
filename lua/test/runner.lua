...
function runner.env_override(m)
  local live = runner.getenv("WEULTRARICH_TEST_LIVE")
  local override = runner.getenv("WEULTRARICH_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("WEULTRARICH_TEST_EXPLAIN")
