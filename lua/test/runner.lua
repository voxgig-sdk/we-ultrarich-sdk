...
function runner.env_override(m)
  local live = runner.getenv("WE_ULTRARICH_TEST_LIVE")
  local override = runner.getenv("WE_ULTRARICH_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("WE_ULTRARICH_TEST_EXPLAIN")
