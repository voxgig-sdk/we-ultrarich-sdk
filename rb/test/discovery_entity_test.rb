...
class DiscoveryEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set WE_ULTRARICH_TEST_DISCOVERY_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def discovery_basic_setup(extra)
  ...
  entid_env_raw = ENV["WE_ULTRARICH_TEST_DISCOVERY_ENTID"]
