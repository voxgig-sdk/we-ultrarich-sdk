...
#      offline in seeded test mode (WeUltrarichSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "WeUltrarich_sdk.rb")
  SDK_CLASS = "WeUltrarichSDK"
