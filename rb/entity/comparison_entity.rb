...
class ComparisonEntity
  ...
  def make
    opts = @_entopts.dup
    ComparisonEntity.new(@_client, opts)
  end
  ...
  # @return [Comparison, Hash] the current Comparison data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Comparison fields)
  def match_get
  ...
  #
  # @param reqmatch [ComparisonLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.Comparison.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [Comparison, Hash] the loaded Comparison; raises WeUltrarichError on failure
