...
class DiscoveryEntity
  ...
  def make
    opts = @_entopts.dup
    DiscoveryEntity.new(@_client, opts)
  end
  ...
  # @return [Discovery, Hash] the current Discovery data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Discovery fields)
  def match_get
  ...
  #
  # @param reqmatch [DiscoveryListMatch, Hash, nil] match filter (any subset of
  #   Discovery fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Discovery>, Array] the matching Discovery items; raises WeUltrarichError on failure
