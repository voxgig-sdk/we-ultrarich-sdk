// Command WeUltrarich-mcp is an MCP server exposing the WeUltrarich
// SDK as MCP tools.
//
// Two tools are registered:
//
//	WeUltrarich_list  — list records of an entity
//	WeUltrarich_load  — load a single record of an entity
//
